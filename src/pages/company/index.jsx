    ...
    <div className="w-1/2 mx-auto mt-10">
      <form onSubmit={handleSubmit}>
        <InputField
          ...
          onBlur={handleBlur}
          error={touched.company_name && errors.company_name ? errors.company_name : ''}
          required
        />
      ...
      {companyList.length > 0 && (
        <div class="relative overflow-x-auto">
          <table class="w-full text-sm border mt-5 text-left rtl:text-right text-gray-500 dark:text-gray-400">
